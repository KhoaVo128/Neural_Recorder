...
##Pmod Header JA
#Sch name = JA1
set_property PACKAGE_PIN J1 [get_ports {SCLK_POS}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {SCLK_POS}]
#Sch name = JA2
set_property PACKAGE_PIN L2 [get_ports {CS_POS}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {CS_POS}]
#Sch name = JA3
set_property PACKAGE_PIN J2 [get_ports {MOSI1_POS}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {MOSI1_POS}]
#Sch name = JA4
set_property PACKAGE_PIN G2 [get_ports {MISO1_POS}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {MISO1_POS}]
#Sch name = JA7
...
#Sch name = JB2
set_property PACKAGE_PIN A16 [get_ports {WR}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {WR}]
#Sch name = JB3
set_property PACKAGE_PIN B15 [get_ports {OE}]					
...
#create_clock -period 16.67 [get_ports USB_CLK]
#Sch name = JB8
set_property PACKAGE_PIN A17 [get_ports {TXE}]					
...
##Pmod Header JC
#Sch name = JC1
set_property PACKAGE_PIN K17 [get_ports {ADBUS[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {ADBUS[0]}]
#Sch name = JC2
set_property PACKAGE_PIN M18 [get_ports {ADBUS[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {ADBUS[1]}]
#Sch name = JC3
set_property PACKAGE_PIN N17 [get_ports {ADBUS[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {ADBUS[2]}]
#Sch name = JC4
set_property PACKAGE_PIN P18 [get_ports {ADBUS[3]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {ADBUS[3]}]
#Sch name = JC7



set_property PACKAGE_PIN L17 [get_ports {ADBUS[4]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {ADBUS[4]}]
#Sch name = JC8
set_property PACKAGE_PIN M19 [get_ports {ADBUS[5]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {ADBUS[5]}]
#Sch name = JC9
set_property PACKAGE_PIN P17 [get_ports {ADBUS[6]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {ADBUS[6]}]
#Sch name = JC10
set_property PACKAGE_PIN R18 [get_ports {ADBUS[7]}]					
